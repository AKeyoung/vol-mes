...
namespace VOL.System.Controllers
{
    public partial class Sys_DictionaryController
    {
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        [HttpGet, Route("GetSearchRemote")]
        [ApiActionPermission()]
        public IActionResult GetSearchRemote(string dicNo, string value)
        {
            return Content(Service.GetSearchRemote(dicNo, value).Serialize());
        }
