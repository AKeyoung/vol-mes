...
using VOL.WebApi.Quartzs;
using VOL.System.Services;
using FormOptions = Microsoft.AspNetCore.Http.Features.FormOptions; // 假设 Pac_Routing_OpService 在此命名空间
...
namespace VOL.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            /****** 自定义定时任务 ******/
            Services.AddTransient<SynchronizeERPJOB>();
            Services.AddTransient<ProductionSchedulingJOB>();

            Services.AddTransient<HttpResultfulJob>();
            Services.AddSingleton<ISchedulerFactory, StdSchedulerFactory>();
            Services.AddSingleton<Quartz.Spi.IJobFactory, IOCJobFactory>();

            // 注册 Pac_Routing_OpService 为作用域服务
            services.AddScoped<Pac_Routing_OpService>();
